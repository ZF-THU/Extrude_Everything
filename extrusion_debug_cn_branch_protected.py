...
def main():
    ...
    # No merge: raw strokes are the graph-topology primitives.
    # For this cylinder-like sketch, raw_strokes are usually:
    #   0: one cap arc
    #   1: another cap/outer arc
    #   2: side/outer contour
    merged_strokes = raw_strokes

    infos = build_stroke_infos(raw_strokes)
